        ...
        <select class="form-control" id="SelectTime" onchange="SelectImg()" >
            ...
            <div class="row  align-items-center justify-content-center">
                ...
                <div>
                    ...
                    <br>
                    <button type="button" class="btn btn-primary btn-sm" onclick="goRealTime()">Real Time</button>
                    <button type="button" class="btn btn-secondary btn-sm" style="float: right;" onclick="goPredict()">Prediction</button>
