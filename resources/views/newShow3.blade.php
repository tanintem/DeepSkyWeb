    ...
    <div class="col light-bg">
        <div class="row  ">
            ...
            <div class="fit-content">
                <h3 style="text-align: left">Satellite Image</h3><br>
                <img id="myImg" class="img-fluid mid-img" src="{{url($dropdown[$real_time]->url)}}"width="679"><br>
                <h3 id='SatelliteTime' style="text-align: right;"></h3>
            </div>
            ...
            <div class="col">
                ...
                <div class="fit-content ">
                    ...
                    <br>
                    <h3 id='PredictionTime' style="text-align: right;"></h3>
                </div>
            </div>
